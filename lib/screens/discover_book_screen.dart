...
class BookCategoryCard extends StatefulWidget {
  final Book book;
  const BookCategoryCard({super.key, required this.book});

  @override
  State<BookCategoryCard> createState() => _BookCategoryCardState();
}

class _BookCategoryCardState extends State<BookCategoryCard> {
