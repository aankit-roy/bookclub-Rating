...
class BookContainerCard extends StatefulWidget {
  final Book book;
  const BookContainerCard({super.key, required this.book});

  @override
  State<BookContainerCard> createState() => _BookContainerCardState();
}

class _BookContainerCardState extends State<BookContainerCard> {
